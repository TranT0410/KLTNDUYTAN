<link rel="stylesheet" type="text/css" href="{{asset('css/bootstrap4/bootstrap.min.css')}}">
	...
	<link rel="stylesheet" type="{{asset('text/css" href="plugins/OwlCarousel2-2.2.1/owl.theme.default.css')}}">
	<link rel="stylesheet" type="{{asset('text/css" href="plugins/OwlCarousel2-2.2.1/animate.css')}}">
