                ...
                <div class="tabs_container">
                    <ul
                        ...
                        <li class="tab" data-active-tab="tab_2">
                            Thông Tin Thêm Về Sản Phẩm</span>
                        </li> -->
                    </ul>
                </div>
            </div>
                                ...
                                <form id="review_form" method="post"
                                    ...
                                    <div>
                                        ...
                                        <textarea id="review_message" class="input_review" name="rate"
                                            placeholder="Đánh giá của bạn" rows="4" required
                                            data-error="Please, leave us a review."></textarea>

                                    </div>
                                    <div class="text-left text-sm-right">
                                        <button id="review_submit" type="submit"
                                            class="red_button review_submit_btn trans_300" value="Submit">Gửi đánh giá
                                        </button>
                                    </div>
                                </form>
                            </div>
