        ...
        <div class="container">
                    ...
                    <div class="cart-list">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    <td class="product-remove" data-id="{{$row['id']}}"
                                        route="{{route('home.cart.delete')}}">X</td>

                                    <td class="image-prod">
                                        <div class="img" style="background-image:url({{Storage::url($row['image'])}});">
                                        </div>
                                    </td>
                                    ...
                                    <td class="quantity">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="number" name="quantity[{{$id}}]"
                                                class="quantity form-control input-number" value="{{$row['quantity']}}"
            ...
            <div class="row justify-content-end">
                ...
                <div class="col-lg-4 mt-5 cart-wrap ftco-animate">
                    ...
                    <p><a href="{{route('home.checkout')}}" class="btn btn-primary py-3 px-4">Tiến tới thanh toán</a>
                    </p>
                </div>
            </div>
        </div>
