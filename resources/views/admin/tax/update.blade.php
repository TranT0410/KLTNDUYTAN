        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                <div class="pd-20 card-box mb-30">
                    <div class="clearfix">
                        <div class="pull-left">
                            <h4 class="text-blue h4">Cập Nhật Thuế</h4>
                        </div>
                    </div>
                    <form action="{{ route('admin.tax.update', $tax->id) }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-12 col-md-10">
                                <input class="form-control" name="name" type="text" value="{{$tax->name}}">
                                @error('name')
                        ...
                        <div class="form-group row">
                          <label class="col-sm-12 col-md-2 col-form-label">Phần Trăm Thuế<span
                                  style="color:red">*</span></label>
                          <div class="col-sm-12 col-md-10">
                              <input class="form-control" name="rate_tax" type="number" value="{{$tax->rate_tax}}" min="0">
                              @error('rate_tax')
                              <span style="color:red" ;>{{ $message }}<span>
                              @enderror
                          </div>
                      ...
                      <div class="form-group row">
                        <label class="col-sm-12 col-md-2 col-form-label">Ngày bắt đầu<span
                                style="color:red">*</span></label>
                        <div class="col-sm-12 col-md-10">
                            <input class="form-control" name="date_start" type="date" value="{{$tax->date_start}}">
                            @error('date_start')
                            <span style="color:red" ;>{{ $message }}<span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row">
                      <label class="col-sm-12 col-md-2 col-form-label">Ngày Kết Thúc<span
                              style="color:red">*</span></label>
                      <div class="col-sm-12 col-md-10">
                          <input class="form-control" name="date_end" type="date" value="{{$tax->date_end}}">
                          @error('date_end')
                          <span style="color:red" ;>{{ $message }}<span>
                          @enderror
                      </div>
